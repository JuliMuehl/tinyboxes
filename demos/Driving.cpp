...
int main(int argc,char** argv){
    ...
    uint64_t ball1 = w.AddBody({Vector3f(-2.0,1,-32),Quaternionf(1,Vector3f(0,0,0)),Vector3f(0,0,0),Vector3f(100,0,0), Matrix3f::Identity(),1.0,collider_sphere});
    uint64_t ball2 = w.AddBody({Vector3f(-2.0,1,-35),Quaternionf(1,Vector3f(0,0,0)),Vector3f(0,0,0),Vector3f(100,0,0), Matrix3f::Identity(),1.0,collider_sphere});
